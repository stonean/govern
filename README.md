...
| [027-bootstrap-migration-registry](specs/027-bootstrap-migration-registry/spec.md) | in-progress | 026 | Replace the monotonically-growing prose-encoded Pre-run Migrations section in [framework/bootstrap/govern.md](../../framework/bootstrap/govern.md) with a machine-readable registry of convention removals. |
