...
- [ ] Tag-push `gvrn-v0.11.0` (triggers the release workflow's 5-leg matrix); after all matrix legs report success, `cargo publish` from `runtime/` to upload `gvrn 0.11.0` to crates.io. Both steps require user authorization (externally visible).
