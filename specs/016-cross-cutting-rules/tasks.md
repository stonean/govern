...
- [x] Rewrite the loading prose to be parameterized: "Load each rule file in the rule-file list (currently `specs/rules/security-backend.md` and `specs/rules/security-frontend.md`) if present in the project. Each file is independently optional."
