...
- Reference: §implement-phase, §pipeline-boundaries, §text-first-artifacts, plus `framework/rules/configuration-cross.md` for constants and env-vars (constitution loaded by `/gov:target` — do not re-read).
